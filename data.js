...
const ARTISTS = [
  ...
  // ==========================================
  {
    ...
    bonusTracks: [],
    impression: "Пару самых популярных песен с рейтинга в Ютуб мюзик. Даже лень писать.\n\nАлёна, сучка, шмара, ты. Бичёвка, рыжая ты.\nСупер неинтересное творчество. Попса для широких масс с элементами рэпа. Ничего интересного, классно звучащего. Контент для аудитории Анны Тринчер.\n«Мама Тереза» — красивая песня, но только парт Джерри Хейл.",
  ...
  },
  {
    ...
    bonusTracks: [],
    impression: "И это, блять, рэпер? Рэпер — это когда у тебя ствол, ну, тебя и называют «Ствол»😂\nТа же хуйня для масс, что и Алёна Алёна. Хоть и должен признать, что мне нравится его этноинтеграция в творчество. Выглядит природно.\nНо слушать я это не буду, спасибо.",
  ...
  },
  {
    ...
    bonusTracks: [],
    impression: "Что-то на уровне «Пляшка Фраголіно».",
  ...
  },
  {
    ...
    bonusTracks: [],
    impression: "Все мы знаем его творчество. Раньше был пацанский рэп: «Сердце пацана» 😭\nСлушал, когда был прям малой, тогда нравилось. Сейчас это не проходит проверку временем.\nНовое творчество ушло больше в поп, патриотизм и военную тематику. Я не прям фанат, но респект и шатаут кидаю ♥️",
  ...
  // ==========================================
  {
    ...
    impression: "Половина песен — рэп, половина — поп. Как рэпер — полная хуета. Його образ — іспанський стид. Тексты — помойка. «В попсі немає правди» — тіп, ти крінж, тому що твої найпопулярніші пісні — це другосортний поп…",
  ...
  },
  {
    ...
    bonusTracks: [],
    impression: "Люта сатира, підходить для танців у TikTok, слухати таке постійно неможливо…\nТільки якщо ти хапаєш.",
    verdict: "💀 Люта сатира",
  ...
  },
  {
    ...
    impression: "Типовий треп/клауд, лайк за популяризацію Живчика та локальні відсилки. Вставки закадрового голосу — ржака: «Знову цей Клонекс»😂\nІмхо, флоу схожий на Soda Luv, у деяких треках не покидає відчуття, ніби слухаєш російський клауд 2020-х років. Що, загалом, корелює з його бекграундом, хоча він на відосах і каже, що не слухає їх і може сам переплюнути західних артистів, проте звучить він непереконливо.\nЗагалом прикольно, хотілося б більше популярних артистів такого жанру та більше оригінальності. Лайк «Ублюдкам».",
  ...
  },
  {
    ...
    bonusTracks: ["220", "К.О"],
    impression: "«Лабуда»: лютий лайк, я так не ржав давно😂😂😂\nОлдскул, актуальні для суспільства теми. Слухати важко, плюс армійська спрямованість, яка мені не близька. Але ознайомитися варто.\n\n«Желаю детям всего лучшего: рак. Я убил русского ровно пять минут назад. Пью чай Ахмат, ебу в рот Ахмат😂\nПатриарх Кирилл сосал Ломаченко в Русской православной церкви 😂»",
  ...
  },
  {
    ...
    impression: "Прикольно. Песни в разных стилях: хип-хоп, трэп, поп. В целом даже вайбово. Но особо ничего выразительного. Песни и слова не запомнились. Лайков нет.",
  ...
  },
  {
    ...
    bonusTracks: [],
    impression: "«На двох» — лютый вайб, лайк. В остальном — ебаная посредственность. А-ля поп-рэп🥸\n«Я живу як ментос у колу»🗿\n«Якщо нам зашити рота, то нам усім пизда» 🫡\nГлубоко. Музыка чисто для какой-то Виктории.",
  ...
  },
  {
    ...
    bonusTracks: ["PsyKhin"],
    impression: "Big Baby Tape? Биты — зачёт, тексты не зацепили.",
  ...
  },
  {
    ...
    impression: "«Київ то є дім» (дякую 4-м мільйонам киян за прослуховування), «Монументально», «Лоу», «Що ти накоїла»..\nЯкийсь недорепер, недопоп-співак…\nПісля рядків «Знаю про тебе багато, бо ми стали друзями, у твоїх минулих стосунках ти була в абʼюзі» викинув і забув.",
  ...
  },
  {
    ...
    impression: "Прикольний чувак, цікава музика. Дуже сподобався інструментал. Цікаво поєднує спів з репом, хоча спів мені подобається більше. У треках відчувається текстура і якийсь сенс. Є фіти з SadSvit, Курган + вайб. Було б цікаво детальніше ознайомитися з творчістю.",
  ...
  },
  {
    ...
    impression: "«Скажена собака» — цікава тема пісні. Мать їбав за те, що вставив 8D-звук стуку в двері. Я так обісрався…\n\nМені сподобалось, як він читає, у тіпа явно є свій стиль. Біти — хуйня. Тексти: теми цікаві, але розкриті хуйово. Можна вполовину різати пісню — і ніхуя не зміниться.\nУ кінці кінців я не зрозумів його. У двох піснях він читає реп, в інших співає.. Там, де співає, — пісні посередні.",
  ...
  },
  {
    ...
    impression: "Trap/cloud rap. Те саме, що і Clonnex, тільки гірше. Жодна пісня не сподобалась. Взагалі незрозуміло, що вони там пиздять у піснях, просто жують слова. Просто не моє.",
  ...
  },
  {
    ...
    impression: "Трэп. Так себе, я бы даже сказал — посредственность.",
  ...
  },
  {
    ...
    bonusTracks: ["Соплі"],
    impression: "Черговий клауд-репер. Посредственность 👎\nЕсть вообще нормальные исполнители, у которых в нике цифры?",
    verdict: "👎 Посередність",
  ...
  },
  {
    ...
    impression: "Шароварщина місцями. За фіт з Альоною Альоною — мінус вайб. Тож він хто? Поп, реп? Поп-реп? Хуйня.",
  ...
  },
  {
    ...
    bonusTracks: [],
    impression: "У типа нет ни одного сингла. Я не ебу, кого там оценивать. На фитах они все одинаковые. Трэп-хуета очередная.",
  ...
  },
  {
    ...
    impression: "Типичный клубняк, трэп. Нет песен на укр. В целом просто хуета, без привязки к языку исполнения.",
  ...
  },
  {
    ...
    impression: "«Всі як один» (правильно — «усі»).\nЕбаная посредственность. Что-то около пацанского рэпа. Вообще ничем не примечательно. Песни для кальянок.",
  ...
  },
  {
    ...
    bonusTracks: ["Catcall"],
    impression: "Клубняк/жіночий треп. Забавно, але не качає. Обкладинки.. фу.. пошлятина (дякую, я подрочив).",
  ...
  },
  {
    ...
    impression: "Обкладинки — чисто відоси MrBeast. Ні слова не зрозумів з того, що він співав. Дуже дивний флоу. Мені не подобається.",
  ...
  },
  {
    ...
    bonusTracks: [],
    impression: "Очередная клауд-хуйня.",
  ...
  },
  {
    ...
    bonusTracks: [],
    impression: "Англомовне музло. Прикольна музика, качає. Потужний голос 😂 Сильно краще за цих однакових клауд-петушків.",
  ...
  },
  {
    ...
    impression: "Треп, в цілому звучить більш-менш, але нічого вау.",
    verdict: "😐 Більш-менш",
  ...
  },
  {
    ...
    impression: "Якщо хтось не чув його творчості, то знайте: нічого не втратили.",
  ...
  },
  {
    ...
    bonusTracks: [],
    impression: "Это пиздец.. Лучше уже МС Петя, в нём хоть прикол какой-то есть🗿",
  ...
  },
  {
    ...
    bonusTracks: [],
    impression: "«Narkotiki» — жиза, в остальном — хуета.",
  ...
  },
  {
    ...
    bonusTracks: [],
    impression: "Очередной нищук, что читает за сучек, которых он трахает, и что никто не шарит за его стиль.",
  ...
  },
  {
    ...
    bonusTracks: ["Brat"],
    impression: "Говно, залупа, пенис, хер, давалка, хуй, блядина…",
  ...
  },
  {
    ...
    bonusTracks: ["Фільм"],
    impression: "Взагалі нічим не відрізняється від конкурентів. Включи мені будь-якого — не відрізню. Посредственность.",
    verdict: "😐 Посередність",
  ...
  },
  {
    ...
    bonusTracks: ["Suzuki"],
    impression: "У мене вже немає фантазії, як обізвати цей блядський унилий андеграунд клауд-реп. Залупа.",
